...
<div class="field is-horizontal">
    ...
    <div class="field-body">
        <div class="field">
            <div class="control">
                <uploader label="صورة الجدول" name="image" @if (isset($table))
                file="{{ $table->image }}" @endif></uploader>            </div>
        </div>
    </div>
</div>
<div class="card-footer">
    <div class="buttons has-addons">
        <a class="button is-info" href="{{ route('admin.tables.index') }}"> الغاء </a>
        <button type="submit" class="button is-success" href="{{ route('admin.tables.index') }}">حفظ</button>
    </div>
  </div>
</div>
